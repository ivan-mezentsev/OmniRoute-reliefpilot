/**
 * Canonical Claude Code client wire-image values.
 *
 * Keep this module dependency-free so executors, compatibility bridges,
 * config defaults, and tests can share one source of truth.
 */
